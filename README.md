...
![BPMN AS IS](https://github.com/SportivityTeam/assistant-vuc-mirea/assets/90286544/c58a10d1-c3bb-4de1-a310-aa38849a90c2)
...
Для определения целевой аудитории за основу был взят метод **`5W Марка Шеррингтона`** и составлена удобная таблица для определения будущего пользователя.
...
В качестве пример будет приведена контекстная диаграмма в **`нотации IDEF0`**, которая будет показывать систему как набор иерархических действий.

![image](https://github.com/SportivityTeam/assistant-vuc-mirea/assets/90286544/730b0095-dc20-4dfa-9440-bfcf1f998ae8)

> Модель просмотра расписания занятий в нотации IDEF0

![image](https://github.com/SportivityTeam/assistant-vuc-mirea/assets/90286544/68a6cc10-decd-4721-a89a-64ab7a053f03)

> Модель просмотра расписания занятий в нотации IDEF0

![image](https://github.com/SportivityTeam/assistant-vuc-mirea/assets/90286544/6db02f6d-16d2-4a6b-9013-1efdb6b68751)
